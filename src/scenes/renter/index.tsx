			...
			<div className="renter-form-wrapper basis-3/5 w-full">
				<div className="renter-form-container bg-white pt-12 h-full w-4/5 m-auto">
					<h2 className="text-center pb-12">
						Fill out the form below to get details on renting a
					...
					>
						...
						<input
							className={inputStyles}
							type="text"
							placeholder="ANY SPECIFIC TYPE OF CAR - WHICH? (optional)"
							{...register("car", {
								required: false,
								maxLength: 100,
							})}
						...
						<input
							className={inputStyles}
							type="text"
							placeholder="HOW FREQUENTLY DO YOU NEED THIS SERVICE? (optional)"
							{...register("frequency", {
								required: false,
								maxLength: 100,
							})}
						...
						{errors.car && (
							...
							rows={4}
							cols={50}
							placeholder="TELL US MORE ABOUT YOU (e.g WHAT TYPE OF WORK YOU DO AND YOUR POSITION)"
							{...register("message", {
								required: false,
								maxLength: 2000,
							})}
